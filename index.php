<?php get_header(); ?>
	...
	<div class="banner container cycle-slideshow" data-cycle-fx="scrollHorz" 
	...
	<div>
		<div class="row container">
			...
			<a href="#" class="veja-todas">Veja todas as Cortinas →</a>
			<?php 
		...
		<div class="row container">
			...
			<a href="#" class="veja-todas">Veja todas as Persianas →</a>
			<?php 
